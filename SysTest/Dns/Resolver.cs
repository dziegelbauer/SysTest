...
namespace SysTest.DNS
{
	...
	public class Resolver
	{
		...
		///		An System.IAsyncResult instance returned by a call to the SysTest.Dns.Resolver.BeginGetHostAddresses(System.String,System.AsyncCallback,System.Object)
		///		method.
		/// </param>
		/// <returns></returns>
		...
		///		SysTest.Dns.Resolver.BeginGetHostByName method.
		/// </param>
		/// <returns></returns>
		...
		/// <param name="AsyncResult">
		///		An System.IAsyncResult instance returned by a call to an 
		///		Overload:SysTest.Dns.Resolver.BeginGetHostEntry method.
		/// </param>
		/// <returns>
		///		An System.Net.IPHostEntry instance that contains address information about
		///		the host. 
